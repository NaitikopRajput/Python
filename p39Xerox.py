print("Enter x if you want to take xerox")
print("Enter t if you want to use typewriter ")
print("Enter b if you want to do Both")
    ...
    if type<50:
        ...
        print("Your bill is", type * 5)
            ...
            if xerox<50:
                ...
                value1=xerox*5
            if type < 50:
                    print("this is your total for typewriter", type*7)
                    value1 = type*7
            else:
                    print("this is your total for typewriter", type*5)
                    value2 = type*5
